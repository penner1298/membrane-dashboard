...
class TestConfig(unittest.TestCase):
    def test_pricing_constants(self):
        self.assertEqual(config.FLASH_INPUT_COST, 0.075)
        self.assertEqual(config.FLASH_OUTPUT_COST, 0.30)
        self.assertEqual(config.PRO_INPUT_COST, 1.25)
        self.assertEqual(config.PRO_OUTPUT_COST, 5.00)
