...
This document records the motivations, hypotheses, testing setups, and baseline simulation results for the Swarm early-rejection experiments. It lives under `docs/internal/` because it is engineering history, not an executable test fixture.
